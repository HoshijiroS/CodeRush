...
static cocos2d::Size designResolutionSize = cocos2d::Size(446, 256);
...
void AppDelegate::initOpenGL()
{
	...
	if (!glview) {
		...
		glview = GLViewImpl::createWithRect("Code Rush!", Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
